...
private fun Preview() {
    View(
        goBack = {}, data = listOf(
            ReportData(
                date = getTodayString(),
                winnerList = listOf(2, 13, 39, 5, 41, 33),
                estimationsWithReward = listOf(listOf(2)),
                estimatedReward = 20
            ),
            ReportData(
                date = getTodayString().getNextDay(1),
                winnerList = listOf(2, 13, 39, 5, 41, 33),
                estimationsWithReward = listOf(listOf(2), listOf(2)),
                estimatedReward = 20
            ),
            ReportData(
                date = getTodayString().getNextDay(2),
                winnerList = listOf(2, 13, 39, 5, 41, 33),
                estimationsWithReward = listOf(listOf()),
                estimatedReward = 20
            ),
            ReportData(
                date = getTodayString().getNextDay(3),
                winnerList = listOf(2, 13, 39, 5, 41, 33),
                estimationsWithReward = listOf(listOf(2)),
                estimatedReward = 20
            ),
