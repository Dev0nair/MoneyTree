...
object DataModule {
    ...
    // section Room
    @Provides
    fun provideItemRepository(roomDataSource: RoomDataSource, retrofitDataSource: RetrofitDataSource): IRepository = RepositoryImpl(roomDataSource, retrofitDataSource)
